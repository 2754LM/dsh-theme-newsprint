...
const THEME_CSS =
  ...
  /* Force the serif on the whole document when the theme is active. dsh's
   * own font chain normally lands here, but we set it again so the chrome
   * (sidebar / header) and the body share a single source of truth. */
  "html.dsh-newsprint-active body { font-family: var(--dsw-font-family); }\n" +
  /* Dark scheme: we ship nothing. dsh's own
   *   body[data-ds-dark-theme] { … }
   * then takes over, producing the stock neutral-black UI. */
