...
const LIGHT_TOKENS = {
  ...
  "--dsw-alias-bg-multi-select": paper.stripe,
  ...
  "--dsw-alias-button-ghost-active-border": paper.ruleSoft,
  "--dsw-alias-button-ghost-active-fill": paper.stripe,
  "--dsw-alias-button-ghost-active-hover": paper.header,
  "--dsw-alias-button-info-fill": accent.blue,
  "--dsw-alias-button-info-hover": accent.blueHover,
  "--dsw-alias-button-primary-dimmed": paper.header,
  ...
  "--dsw-alias-markdown-citation": paper.header,
  "--dsw-alias-markdown-code-block": paper.header,
  "--dsw-alias-markdown-code-block-banner": paper.container,
  "--dsw-alias-markdown-code-segment-selected": paper.raised,
  "--dsw-alias-markdown-code-segment-unselected": paper.header,
  "--dsw-alias-markdown-inline-code": paper.header,
  "--dsw-alias-markdown-placeholder": paper.container,
  "--dsw-alias-markdown-tag": paper.header,
  "--dsw-alias-scrollbar-bg-l1": paper.header,
  "--dsw-alias-scrollbar-bg-l2": paper.rule,
  "--dsw-alias-scrollbar-hover-l1": paper.ruleSoft,
  "--dsw-alias-scrollbar-hover-l2": paper.ruleDeep,
  "--dsw-alias-state-business-primary": accent.blue,
  "--dsw-alias-state-business-tertiary": paper.header,
  ...
  "--dsw-specific-bubble-highlight": paper.header,
  "--dsw-specific-input-major": paper.raised,
  "--dsw-specific-login-input": paper.container,
  "--dsw-specific-selector": paper.container,
  "--dsw-specific-sidebar-fill": paper.container,
  "--dsw-specific-sidebar-nav-item-active": paper.header,
  "--dsw-specific-sidebar-nav-item-active-accent": paper.header,
  ...
  "--newsprint-quote-border": paper.ruleSoft,
  "--newsprint-quote-text": ink.secondary,
  "--newsprint-thead-bg": paper.header,
